 ...
 */
use bevy::{render::{mesh, render_resource::PrimitiveTopology}, prelude::Mesh};
...
pub struct Model {
    pub indexes   : Box<Vec<u32>>,
    pub positions : Box<Vec<[f32; 3]>>,
    pub normals   : Box<Vec<[f32; 3]>>
}
...
impl Model {
    ...
    pub fn to_mesh(&self) -> bevy::render::mesh::Mesh {
        ...
        mesh.set_indices(Some(mesh::Indices::U32(*self.indexes)));
        mesh
    }
}
